...
class BinaryTree():
    ...
    def preorder(self, start, traversal):
        ...
        list = []
        if start:
            list.append(start.value)
            list += self.preorder(start.left, traversal)
            list += self.preorder(start.right, traversal)
        return list
    ...
    def inorder(self, start, traversal):
        ...
        list = []
        if start:
            list += self.inorder(start.left, traversal)
            list.append(start.value)
            list += self.inorder(start.right, traversal)
        return list
    ...
    def postorder(self, start, traversal):
        ...
        list = []
        if start:
            list += self.postorder(start.left, traversal)
            list += self.postorder(start.right, traversal)
            list.append(start.value)
        return list
    ...
    def __len__helper(node):
        ...
        x = 1
        if node.left:
            x += BinaryTree.__len__helper(node.left)
        if node.right:
            x += BinaryTree.__len__helper(node.right)
        return x
