def range(a, b=None, c=None):
    '''
    This function should behave exactly
    like the built-in range function.
    For example:
    ...
    written in the C programming language rather than natively in python.
    ...
    python code because it can remove some of the
    overhead of this automation process,
